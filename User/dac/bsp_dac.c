...
const uint16_t Sine12bit[POINT_NUM] = {
  2000,2292,2574,2833,3060,3247,
  3385,3471,3499,3471,3385,3247,
  3060,2833,2574,2292,2000,1707,
  1425,1166,939,752,614,528,
  500,528,614,752,939,1166,
  1425,1707,
};
...
static void DAC_TIM_Config(void)
{
    ...
    TIM_TimeBaseStructure.TIM_Period = (6 - 1);                 //定时周期
    TIM_TimeBaseStructure.TIM_Prescaler = (150 - 1); //预分频 72M / (0+1) = 72M
